...
export type HerobannerRecord = RecordInterface & {
...
/** The query root for this schema */
export type Query_AllTestcontentsMetaArgs = {
  filter?: InputMaybe<TestcontentModelFilter>;
  locale?: InputMaybe<SiteLocale>;
};
...
/** The query root for this schema */
export type QueryAllTestcontentsArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<TestcontentModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<TestcontentModelOrderBy>>>;
  skip?: InputMaybe<Scalars['IntType']['input']>;
};
...
export type TestcontentModelFilter = {
  AND?: InputMaybe<Array<InputMaybe<TestcontentModelFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<TestcontentModelFilter>>>;
  _createdAt?: InputMaybe<CreatedAtFilter>;
  _firstPublishedAt?: InputMaybe<PublishedAtFilter>;
  _isValid?: InputMaybe<BooleanFilter>;
  _publicationScheduledAt?: InputMaybe<PublishedAtFilter>;
...
export enum TestcontentModelOrderBy {
  CreatedAtAsc = '_createdAt_ASC',
  CreatedAtDesc = '_createdAt_DESC',
  FirstPublishedAtAsc = '_firstPublishedAt_ASC',
  FirstPublishedAtDesc = '_firstPublishedAt_DESC',
...
/** Record of type TestContent (testcontent) */
export type TestcontentRecord = RecordInterface & {
  __typename?: 'TestcontentRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Record of type TestContent (testcontent) */
export type TestcontentRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type ValuepropstripRecord = RecordInterface & {
  __typename?: 'ValuepropstripRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
export type TestQueryQuery = { __typename?: 'Query', allTestcontents: Array<{ __typename?: 'TestcontentRecord', id: any, title?: string | null }> };
